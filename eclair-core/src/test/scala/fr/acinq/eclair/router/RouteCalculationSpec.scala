...
class RouteCalculationSpec extends FunSuite {
  ...
  test("calculate route and return metadata") {
    ...
    val uab = ChannelUpdate(DUMMY_SIG, Block.BCARegtestForkBlockHash, ShortChannelId(1L), 0L, 0, 0, 1, 42, 2500, 140, None)
    val uba = ChannelUpdate(DUMMY_SIG, Block.BCARegtestForkBlockHash, ShortChannelId(1L), 1L, 0, 1, 1, 43, 2501, 141, None)
    val ubc = ChannelUpdate(DUMMY_SIG, Block.BCARegtestForkBlockHash, ShortChannelId(2L), 1L, 0, 0, 1, 44, 2502, 142, None)
    val ucb = ChannelUpdate(DUMMY_SIG, Block.BCARegtestForkBlockHash, ShortChannelId(2L), 1L, 0, 1, 1, 45, 2503, 143, None)
    val ucd = ChannelUpdate(DUMMY_SIG, Block.BCARegtestForkBlockHash, ShortChannelId(3L), 1L, 1, 0, 1, 46, 2504, 144, Some(500000000L))
    val udc = ChannelUpdate(DUMMY_SIG, Block.BCARegtestForkBlockHash, ShortChannelId(3L), 1L, 0, 1, 1, 47, 2505, 145, None)
    val ude = ChannelUpdate(DUMMY_SIG, Block.BCARegtestForkBlockHash, ShortChannelId(4L), 1L, 0, 0, 1, 48, 2506, 146, None)
    val ued = ChannelUpdate(DUMMY_SIG, Block.BCARegtestForkBlockHash, ShortChannelId(4L), 1L, 0, 1, 1, 49, 2507, 147, None)
...
object RouteCalculationSpec {
  ...
  def makeChannel(shortChannelId: Long, nodeIdA: PublicKey, nodeIdB: PublicKey) = {
    ...
    ChannelAnnouncement(DUMMY_SIG, DUMMY_SIG, DUMMY_SIG, DUMMY_SIG, "", Block.BCARegtestForkBlockHash, ShortChannelId(shortChannelId), nodeId1, nodeId2, randomKey.publicKey, randomKey.publicKey)
  }
  ...
  def makeUpdate(shortChannelId: Long, nodeId1: PublicKey, nodeId2: PublicKey, feeBaseMsat: Int, feeProportionalMillionth: Int): (ChannelDesc, ChannelUpdate) =
    (ChannelDesc(ShortChannelId(shortChannelId), nodeId1, nodeId2) -> ChannelUpdate(DUMMY_SIG, Block.BCARegtestForkBlockHash, ShortChannelId(shortChannelId), 0L, 0, 0, 1, 42, feeBaseMsat, feeProportionalMillionth, None))
