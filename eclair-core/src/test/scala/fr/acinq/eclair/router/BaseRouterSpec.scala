...
abstract class BaseRouterSpec extends TestkitBaseClass {
  ...
  val channelUpdate_ab = makeChannelUpdate(Block.BCARegtestForkBlockHash, priv_a, b, channelId_ab, cltvExpiryDelta = 7, 0, feeBaseMsat = 766000, feeProportionalMillionths = 10)
  val channelUpdate_ba = makeChannelUpdate(Block.BCARegtestForkBlockHash, priv_b, a, channelId_ab, cltvExpiryDelta = 7, 0, feeBaseMsat = 766000, feeProportionalMillionths = 10)
  val channelUpdate_bc = makeChannelUpdate(Block.BCARegtestForkBlockHash, priv_b, c, channelId_bc, cltvExpiryDelta = 5, 0, feeBaseMsat = 233000, feeProportionalMillionths = 1)
  val channelUpdate_cb = makeChannelUpdate(Block.BCARegtestForkBlockHash, priv_c, b, channelId_bc, cltvExpiryDelta = 5, 0, feeBaseMsat = 233000, feeProportionalMillionths = 1)
  val channelUpdate_cd = makeChannelUpdate(Block.BCARegtestForkBlockHash, priv_c, d, channelId_cd, cltvExpiryDelta = 3, 0, feeBaseMsat = 153000, feeProportionalMillionths = 4)
  val channelUpdate_dc = makeChannelUpdate(Block.BCARegtestForkBlockHash, priv_d, c, channelId_cd, cltvExpiryDelta = 3, 0, feeBaseMsat = 153000, feeProportionalMillionths = 4)
  val channelUpdate_ef = makeChannelUpdate(Block.BCARegtestForkBlockHash, priv_e, f, channelId_ef, cltvExpiryDelta = 9, 0, feeBaseMsat = 786000, feeProportionalMillionths = 8)
  val channelUpdate_fe = makeChannelUpdate(Block.BCARegtestForkBlockHash, priv_f, e, channelId_ef, cltvExpiryDelta = 9, 0, feeBaseMsat = 786000, feeProportionalMillionths = 8)
